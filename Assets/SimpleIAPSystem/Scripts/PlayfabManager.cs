...
namespace SIS
{
    ...
    public class PlayfabManager : MonoBehaviour
    {
        ...
        public static IEnumerator SetPurchase(List<string> productIDs)
        {
            ...
            {
                Debug.Log("Should upload: " + productIDs[i]);
        ...
        {
            Debug.LogError("[" + GetAuthSessionTicketResponse_t.k_iCallback + " - GetAuthSessionTicketResponse] - " + pCallback.m_eResult + " -- " + pCallback.m_hAuthTicket);
