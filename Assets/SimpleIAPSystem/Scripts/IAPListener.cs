        ...
        public void HandleSuccessfulPurchase(string id)
        {
            ...
            switch (id)
            {
                ...
                case "si_x2":
                    ...
                    iosAchievementsManager.Instance.BuyDoubleScoreAchievement();
                    break;
                case "si_1up":
                    ...
                    iosAchievementsManager.Instance.BuyReviveAchievement();
                    break;
                case "si_1gem":
                    ...
                    iosAchievementsManager.Instance.IncrementGemsEarnedAchievements(1);
                    break;
                case "si_5gems":
                    ...
                    iosAchievementsManager.Instance.IncrementGemsEarnedAchievements(5);
                    break;
                case "si_10gems":
                    Rad_SaveManager.profile.gems += 10;
                    DBManager.IncreaseFunds("gems", 10);
                    AnalyticsManager.Instance.Item_Bought_Event("10 Gems");
                    iosAchievementsManager.Instance.IncrementGemsEarnedAchievements(10);
                ...
                case "si_20gems":
                    ...
                    iosAchievementsManager.Instance.IncrementGemsEarnedAchievements(20);
                ...
                case "si_yellowsword":
                    ...
                    iosAchievementsManager.Instance.BuyAllSwordsAchievement();
                    break;
                case "si_bluesword":
