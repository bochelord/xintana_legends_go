...
public class AdsManager : MonoBehaviour {
    ...
    private void HandleResultExtraLife(ShowResult result)
    {
        ...
        switch (result)
        {
            case ShowResult.Finished:
                ...
                iosAchievementsManager.Instance.ReviveAdAchievement();
                break;
    ...
    private void HandlResultFreeShell(ShowResult result)
    {
        ...
        switch (result)
        {
            case ShowResult.Finished:
                ...
                iosAchievementsManager.Instance.TokenAdAchievement();
                break;
    ...
    private void AdsViewedIncrement()
    {
        ...
        iosAchievementsManager.Instance.IncrementAdsWatchedAchievements();
    }
