...
public class AdsManager : MonoBehaviour {
    ...
    private void HandleResultExtraLife(ShowResult result)
    {
        ...
        switch (result)
        {
            case ShowResult.Finished:
                ...
                AmazonAchievementsManager.Instance.ReviveAdAchievement();
                break;
    ...
    private void HandlResultFreeShell(ShowResult result)
    {
        ...
        switch (result)
        {
            case ShowResult.Finished:
                ...
                AmazonAchievementsManager.Instance.TokenAdAchievement();
                break;
    ...
    private void AdsViewedIncrement()
    {
        ...
        AmazonAchievementsManager.Instance.IncrementAdsWatchedAchievements();
    }
