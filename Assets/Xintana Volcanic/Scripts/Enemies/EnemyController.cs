...
public class EnemyController : MonoBehaviour {
    ...
    void OnEnable() // On Enable we need to replenish its life otherwise would appear as a Zombie
    {
        ...
        if (new_enemy.type == EnemyType.blackKnight || new_enemy.type == EnemyType.lavabeast || new_enemy.type == EnemyType.alchemist || new_enemy.type == EnemyType.devil || new_enemy.type == EnemyType.explorer)
        {
