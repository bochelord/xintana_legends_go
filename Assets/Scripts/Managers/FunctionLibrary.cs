...
{
    //public delegate IEnumerator myEnumeratorDelegate();
    public delegate void myDelegate();
    public delegate void myDelegateInt(int i);
    public delegate void myDelegateObj(GameObject obj);
    public delegate void myDelegateBool(bool trigger);
    ...
    public static IEnumerator CallWithDelay(myDelegateBool del, bool trigger, float delay)
    {
        yield return new WaitForSeconds(delay);
        del(trigger);
    }

    //public static IEnumerator CallEnumeratorWithDelay(myEnumeratorDelegate del, float delay)
    //{
    //    yield return new WaitForSeconds(delay);
    //    StartCoroutine(del());
    //}
