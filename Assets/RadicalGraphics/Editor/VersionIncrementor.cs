...
public class VersionIncrementor
{
    ...
    static void ReadVersionAndIncrementBundle()
    {
        ...
        //Debug.Log("AndroidBundleVersionCode" + PlayerSettings.Android.bundleVersionCode);
    ...
    //    string versionText = FileHandle.ReadAllText(versionTextFileNameAndPath);
    ...
    //        FileHandle.WriteAllText(versionTextFileNameAndPath, versionText);
    ...
    //        FileHandle.WriteAllText(versionTextFileNameAndPath, "0.0.0.a");
    //    }
    //}
